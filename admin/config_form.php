...
<form method="POST" name="form1" action="index.php?page=edit-main">
    ...
    <div class="admin-config">
        ...
        <div class="admin-config-right">
            <label>
                <input type="text" name="MYSQL_USER" size="29" value="<?php echo MDSConfig::get( 'MYSQL_USER', true ); ?>"/>
            </label>
        </div>
        ...
        <div class="admin-config-right">
            <label>
                <input type="password" name="MYSQL_PASS" size="29" value="<?php echo MDSConfig::get( 'MYSQL_PASS', true ); ?>"/>
            </label>
        </div>
        ...
        <div class="admin-config-right">
            <label>
                <input type="text" name="MYSQL_DB" size="29" value="<?php echo MDSConfig::get( 'MYSQL_DB', true ); ?>"/>
            </label>
        </div>
        ...
        <div class="admin-config-right">
            <label>
                <input type="text" name="MYSQL_HOST" size="29" value="<?php echo MDSConfig::get( 'MYSQL_HOST', true ); ?>"/>
            </label>
        </div>
        ...
        <div class="admin-config-right">
            <label>
                <input type="text" name="MYSQL_PORT" size="29" value="<?php echo MDSConfig::get( 'MYSQL_PORT', true ); ?>"/>
            </label>
        </div>

        <div class="admin-config-left">
            MySQL Server Socket (optional)
        </div>
        <div class="admin-config-right">
            <label>
                <input type="text" name="MYSQL_SOCKET" size="29" value="<?php echo MDSConfig::get( 'MYSQL_SOCKET', true ); ?>"/>
            </label>
        </div>
    </div>
