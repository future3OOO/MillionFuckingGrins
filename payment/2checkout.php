        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <table border="0" cellpadding="5" cellspacing="2" style="border-style:groove" width="100%" bgcolor="#FFFFFF">
                ...
                <tr>
                    ...
                    <td bgcolor="#e6f2ea"><font face="Verdana" size="1">
                            <input type="radio" name="_2co_demo" value="Y" <?php if ( $_2co_demo == 'Y' ) {
								echo " checked ";
							} ?> >Yes <br>
                            <input type="radio" name="_2co_demo" value="N" <?php if ( $_2co_demo == 'N' ) {
								echo " checked ";
							} ?> >No<br></font></td>
                </tr>
                <tr>
                    ...
                    <td bgcolor="#e6f2ea"><font face="Verdana" size="1">
                            <input type="radio" name="_2co_verify_ssl" value="Y" <?php if ( $_2co_verify_ssl == 'Y' ) {
								echo " checked ";
							} ?> >Yes <br>
                            <input type="radio" name="_2co_verify_ssl" value="N" <?php if ( $_2co_verify_ssl == 'N' ) {
								echo " checked ";
							} ?> >No<br></font></td>
                </tr>
                <tr>
		...
		if ( $passback['response_code'] == 'Success' ) {
			...
			if ( $_REQUEST['key'] != '' ) {
				...
				if ( $credit_card_processed == 'Y' ) {
					...
					<?php
				} else if ( $credit_card_processed == 'K' ) {
					# credit card pending
