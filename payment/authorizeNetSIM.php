        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <table border="0" cellpadding="5" cellspacing="2" style="border-style:groove" width="100%" bgcolor="#FFFFFF">
                ...
                <tr>
                    ...
                    <td bgcolor="#e6f2ea"><font face="Verdana" size="1">
                            <input type="radio" name="authnet_test_mode" value="YES" <?php if ( $authnet_test_mode == 'YES' ) {
								echo " checked ";
							} ?> >Yes <br>
                            <input type="radio" name="authnet_test_mode" value="NO" <?php if ( $authnet_test_mode == 'NO' ) {
								echo " checked ";
							} ?> >No<br></font></td>
                </tr>
