...
function field_type_option_list( $form_id, $selected ) {
	...
	switch ( $form_id ) {
		...
		case 1:
			...
			?>
            <option <?php if ( $col_row['field_id'] == 'ad_date' ) {
				echo ' selected ';
			} ?> value="ad_date"><?php echo 'Ad Date'; ?></option>
            <option <?php if ( $col_row['field_id'] == 'ad_id' ) {
				echo ' selected ';
			} ?> value="ad_id"><?php echo 'Ad ID'; ?></option>
            <option <?php if ( $col_row['field_id'] == 'user_id' ) {
				echo ' selected ';
			} ?> value="user_id"><?php echo 'User ID'; ?></option>
            <option <?php if ( $col_row['field_id'] == 'order_id' ) {
				echo ' selected ';
			} ?> value="order_id"><?php echo 'Order ID'; ?></option>
            <option <?php if ( $col_row['field_id'] == 'grid_id' ) {
				echo ' selected ';
			} ?> value="grid_id"><?php echo 'Grid ID'; ?></option>
			<?php
			break;
