...
$label['advertiser_write_ad_button']         = 'Write Your Ad ->>';
...
This means that your payment was received, and the funds
...
<a class="pixel-url" target="_blank" href="http://%URL%">%URL%</a><br>
%IMAGE%<br>
';
